public class Constants {
    ...
    // image locations
    public static final String BACKGROUND_IMAGE_URL = "./src/com/cosmogame/background.jpg";
    public static final String SPACESHIP_IMAGE_URL = "./src/com/cosmogame/spaceship.png";
    public static final String BOMB_IMAGE_URL = "./src/com/cosmogame/bomb.png";
    public static final String LASER_IMAGE_URL = "./src/com/cosmogame/laser.png";
    public static final String UFO_IMAGE_URL = "./src/com/cosmogame/ufo.png";
